...
import vg from "../assets/p1p2.webp";
...
const Home = () => {
  return (
    ...
    <div className="home2">
        ...
        <div>
            <p>
                We are your one and only Solution too the tech problem you face every day. We are leading tech company whose aim is to increase the problem solving ability to children.
            </p>
        </div>
    </div>
